"""Subscribe to indications of a BME280 sensor in Security Mode 1
Level 2.
...
async def connect(address):
    """Connect and pair to BME280 sensor and subscribe to
    indications."""
    try:
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 2:
        ...
        print("Please specify the BLE MAC address.")
